...
We conducted a quantitative analysis based on the models' performance curves as a function of the number of annotated examples, shown in Figure~\ref{f:results_charts}. We chose the Dice score as the main evaluation metric, which is widely used in medical segmentation tasks.
