...
\begin{table*}[t]
    ...
    \begin{tabular}{l l l r l l}nossnsa
        \hline
        \textbf{Stage} & \textbf{Model} & \textbf{Loss} & \textbf{Batch} & \textbf{LR} & \textbf{Weight decay} \\
        \hline
        \multirow{2}{*}{Pre-training (VessShape)} & VSUNet18 & Cross-entropy & 192 & $10^{-2}$ & 0.0 \\
         & VSUNet50 & Cross-entropy & 96 & $10^{-3}$ & $10^{-4}$ \\
        \hline
        \multirow{3}{*}{Fine-tuning (target datasets)} & VSUNet18 / IN-UNet18 & Cross-entropy & 8 & $10^{-2}$ & 0.0 \\
         & VSUNet50 / IN-UNet50 & Cross-entropy & 8 & $10^{-3}$ & 0.0 \\
         & LiteMedSAM-FT & BCE & 8 & $10^{-3}$ & 0.0 \\
        \hline
    \end{tabular}
    \endgroup
    \\[3pt]
    {\footnotesize Input resize per dataset: DRIVE $512{\times}512$, OCTA2D $384{\times}384$, DCA1 $288{\times}288$, VessMAP $256{\times}256$; LiteMedSAM-FT always uses $256{\times}256$.}
\end{table*}
...
\hline
\textbf{Dataset} & \textbf{N} & \textbf{VSUNet18} & \textbf{VSUNet50} & \textbf{LiteMedSAM-FT} & \textbf{UNet18} & \textbf{UNet50} \\
\hline
\multirow{3}{*}{DRIVE} & 0 & $\mathbf{55.3} \,\pm\, 0.0$ & $17.5 \,\pm\, 0.0$ & $0.0 \,\pm\, 0.0$ & --- & --- \\
 & 1 & $\mathbf{76.1} \,\pm\, 0.7$ & $75.3 \,\pm\, 1.5$ & $66.5 \,\pm\, 7.5$ & $65.8 \,\pm\, 9.5$ & $68.4 \,\pm\, 4.6$ \\
 & 16 & $79.7 \,\pm\, 0.1$ & $\mathbf{79.9} \,\pm\, 0.1$ & $78.4 \,\pm\, 0.2$ & --- & --- \\
\hline
\multirow{3}{*}{OCTA2D} & 0 & $27.2 \,\pm\, 0.0$ & $\mathbf{47.0} \,\pm\, 0.0$ & $0.0 \,\pm\, 0.0$ & --- & --- \\
 & 1 & $80.4 \,\pm\, 2.1$ & $\mathbf{80.5} \,\pm\, 2.1$ & $78.7 \,\pm\, 4.1$ & $78.0 \,\pm\, 4.2$ & $79.6 \,\pm\, 2.6$ \\
 & 20 & $\mathbf{87.1} \,\pm\, 0.3$ & $85.7 \,\pm\, 0.2$ & $86.2 \,\pm\, 0.4$ & $87.0 \,\pm\, 0.6$ & $86.4 \,\pm\, 0.3$ \\
\hline
\multirow{3}{*}{DCA1} & 0 & $\mathbf{53.6} \,\pm\, 0.0$ & $48.0 \,\pm\, 0.0$ & $0.9 \,\pm\, 0.0$ & --- & --- \\
 & 1 & $\mathbf{54.7} \,\pm\, 7.9$ & $46.8 \,\pm\, 12.3$ & $50.9 \,\pm\, 12.1$ & --- & --- \\
 & 20 & $76.7 \,\pm\, 1.3$ & $75.6 \,\pm\, 1.7$ & $\mathbf{76.9} \,\pm\, 0.7$ & $71.2 \,\pm\, 2.3$ & $71.9 \,\pm\, 2.8$ \\
\hline
\multirow{3}{*}{VessMAP} & 0 & $\mathbf{76.6} \,\pm\, 0.0$ & $63.8 \,\pm\, 0.0$ & $0.0 \,\pm\, 0.0$ & --- & --- \\
 & 1 & $\mathbf{59.7} \,\pm\, 12.4$ & $58.4 \,\pm\, 11.4$ & $58.1 \,\pm\, 11.7$ & $49.1 \,\pm\, 6.0$ & $48.0 \,\pm\, 6.5$ \\
 & 20 & $85.7 \,\pm\, 1.5$ & $84.3 \,\pm\, 1.4$ & $\mathbf{89.5} \,\pm\, 0.6$ & $83.0 \,\pm\, 2.4$ & $72.6 \,\pm\, 4.4$ \\
\hline
\end{tabular}
    \endgroup
\end{table*}
